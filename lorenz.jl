...
# ╔═╡ e8cd07c6-5d17-43dd-9d99-2f9202cfa6cf
using StaticArrays, Plots, PlutoUI

# ╔═╡ 4eb891b2-f3cf-4c79-a8b9-fd9b63e9a1af
const Vec3 = SVector{3}

# ╔═╡ af38c9d7-d064-401b-99c2-0c2d0575aa34
...
# ╔═╡ d37d4757-60fb-4a6d-a2e8-e50d034d9c5a
mutable struct State
	pts::Vector{Vec3}
end

# ╔═╡ 1629cf70-6138-11ef-3ecd-fb4723f932d4
function next(v::Vec3, dt, s::Settings)
	delta = Vec3(
		s.σ * (v.y - v.x),
		v.x * (s.ρ - v.z) - v.y,
		v.x * v.y - s.β * v.z,
